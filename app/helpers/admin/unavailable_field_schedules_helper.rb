module Admin::UnavailableFieldSchedulesHelper
  def all_statuses
...
"include_time"]
  ...
  def handle_render_schedules schedules
    schedules.map do |schedule|
      format_schedule_date schedule
      format_schedule_time schedule
      schedule.display_status = resolve_schedule_status_to_html schedule
      schedule.display_created_at = schedule.created_at
                                            .strftime Settings.date_time_format
      schedule.action = resolve_schedule_action_to_html schedule
      schedule
    end
  end
  ...
  def format_schedule_date schedule
